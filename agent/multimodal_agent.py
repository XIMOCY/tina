...
from ..llm.BaseAPI import BaseMultimodalAPI
...
class MultimodalAgent:
    ...
    def __init__(self,
        ...
        if context_manager is None:
            self.context_manager = MultimodalContextManager(tools=self.tools)
        else:
    ...
    def run(self,stream:callable):
        """
        run 的 Docstring
        
        :param self: 说明
        :param stream: 说明
        :type stream: callable
        """
